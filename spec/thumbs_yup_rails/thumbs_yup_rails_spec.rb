...
RSpec.describe ThumbsYupRails do
  before do
    allow(ThumbsYupRails::ServerEmbed).to receive(:json_review_data).and_return(
      {
        "metadata" => {
          "current_page" => 1,
          "total_count" => 1,
  ...
  it "has a version number" do
    expect(ThumbsYupRails::VERSION).not_to be nil
  end

  it "renders a review template for the collection of reviews" do
    reviews_html = ThumbsYupRails::ServerEmbed.render_public_reviews
